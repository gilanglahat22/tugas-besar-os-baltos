...
void shell(byte buf[2880][512]) {
    ...
    insert_file(buf, "program_tes", 1);

    insert_file(buf, "file_src/tc_a/file3", 0xFF);
    insert_file(buf, "file_src/tc_a/file1", 0xFF);
    insert_file(buf, "file_src/tc_a/file2", 0xFF);
}
